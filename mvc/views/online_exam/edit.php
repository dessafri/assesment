                ...
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            echo form_dropdown("groupID", $array, set_value("groupID",$online_exam->groupID), "id='groupID' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group <?=form_error('ispaid') ? 'has-error' : '' ?>" id="ispaidDiv" style="display: none;" >
                        ...
                        <div class="col-sm-6">
                            <?php
                                ...
                                echo form_dropdown("ispaid", $array, set_value("ispaid", 0), "id='ispaid' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
