                                    ...
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-sm-2">Register Number</th>
                                        ...
                                        <tbody>
                                            <?php if(inicompute($students)) {$i = 1; foreach($students as $student) { ?>
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <td data-title="<?=$this->lang->line('student_email')?>">
                                                        <span style="display: none;" class="hidden-data"><?php echo $student->username; ?></span>
                                                    </td>
                                                    <td data-title="<?=$this->lang->line('student_email')?>">
                                                        <span style="display: none;" class="hidden-data"><?php echo $student->password ?></span>
                                                    </td>
