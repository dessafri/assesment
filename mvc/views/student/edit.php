        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group <?=form_error('DiriSendiriID') ? 'has-error' : ''?>">
                        <label for="BawahanID" class="col-sm-2 control-label">
                            Diri Sendiri
                        </label>
                        <div class="col-sm-6">
                            <?php
                            $selectedStudentIDsDiriSendiri = array_map(function($DiriSendiri) {
                                return $DiriSendiri->studentID;
                            }, $DiriSendiri);
                            foreach ($students_data as $data) {
                                $array[$data->studentID] = $data->name;
                            }
                                echo form_multiselect("DiriSendiriID[]", $array, $selectedStudentIDsDiriSendiri, "id='DiriSendiriID' class='form-control guargianID select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('DiriSendiriID'); ?>
                        </span>
                    </div>
